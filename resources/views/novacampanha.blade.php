    ...
    <body>
        ...
        <div id="main">
            ...
            <div class='secao-iframe'>
                <iframe src='https://vendas.empresadigital.net.br/index.php?module=Campaigns&action=WizardHome&return_module=Campaigns&return_action=index' width='100%' height='100%' border="0px" border="0px"></iframe>
            </div>
        </div>
