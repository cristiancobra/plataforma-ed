        ...
        <div class="col-2 pt-5"
         ...
         ">
            <p class="mt-2 text-center" style="color:#8B2485">
                ...
                CONTATOS
                <br>
                <a class="text-button btn-info mt-2" name="new_contacts"
                    href="{{ route('contact.index', ['created_at' => date('Y-m-d', strtotime('-7 days'))]) }}">
        ...
        <div class="col-2 pt-5"
         ...
         ">
            <p class="mt-2 text-center" style="color:#8B2485">
                ...
                <br>
                <br>
                <a class="text-button btn-info" name="new_contacts"
                    href="{{ route('opportunity.index', ['created_at' => date('Y-m-d', strtotime('-7 days'))]) }}">
                    +{{ $opportunitiesWon }} esta semana
                </a>
                <br>
                <br>
                <a class="text-button btn-danger" name="new_contacts"
                    href="{{ route('opportunity.index', ['created_at' => date('Y-m-d', strtotime('-7 days'))]) }}">
