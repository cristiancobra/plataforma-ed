...
@section('form_start')
        ...
        <div class="row">
            <div class="col  d-flex justify-content-end">
                ...
                <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                    ...
                    onkeyup="formatCurrencyReal('goal_invoices_revenues')" value='{{ $goal->goal_invoices_revenues }}'>
            </div>
        </div>
        <div class="row ms-2">
            <div class='form-check d-flex justify-content-start'>
        ...
        <div class="row">
            <div class="col  d-flex justify-content-end">
                ...
                <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                    ...
                    onkeyup="formatCurrencyReal('goal_invoices_expenses')" value='{{ $goal->goal_invoices_expenses }}'>
            </div>
        </div>
        <div class="row ms-2">
            <div class='form-check d-flex justify-content-start'>
        ...
        <div class="row">
            <div class="col  d-flex justify-content-end">
                ...
                <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                    ...
                    value='{{ $goal->goal_transactions_revenues }}'>
            </div>
        </div>
        <div class="row ms-2">
            <div class='form-check d-flex justify-content-start'>
                <input class='form-check-input mt-2' type='radio' name='type' id='saída' value='saída'
                    {{ $goal->type == 'saída' ? 'checked' : '' }}'>
        ...
        <div class="row">
            <div class="col  d-flex justify-content-end">
                ...
                <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                    ...
                    value='{{ $goal->goal_transactions_expenses }}'>
            </div>
        </div>
    @endsection
        ...
        <div class='col-3' style='text-align: center'>
            <div class='show-field-end'>
                ...
                <div class='form-check d-flex justify-content-start'>
                    ...
                    <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                        name='goal_invoices_revenues' value='{{ $goal->goal_invoices_revenues }}'>
                </div>
                <div class='form-check d-flex justify-content-start'>
                    <input class='form-check-input mt-2' type='radio' name='type' id='despesa' value='despesa'
                        {{ $goal->type == 'despesa' ? 'checked' : '' }}'>
                    <label class='form-check-label pt-2 ms-2' for='despesa' style="text-align: right;font-weight:600">
                        DESPESA:
                    </label>
                    <p class='form-check-label pt-2 ms-2' for='despesa' style="text-align: right">
                    ...
                    <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                        name='goal_invoices_expenses' value='{{ $goal->goal_invoices_expenses }}'>
                </div>
                <div class='form-check d-flex justify-content-start'>
                    <input class='form-check-input mt-2' type='radio' name='type' id='entrada' value='entrada'
                        {{ $goal->type == 'entrada' ? 'checked' : '' }}'>
                    <label class='form-check-label pt-2 ms-2' for='entrada' style="text-align: right;font-weight:600">
                        ENTRADAS:
                    </label>
                    <p class='form-check-label pt-2 ms-2' for='entrada' style="text-align: right">
                    ...
                    <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                        name='goal_transactions_revenues' value='{{ $goal->goal_transactions_revenues }}'>
                </div>
                <div class='form-check d-flex justify-content-start'>
                    ...
                    <input class='form-control ms-2 mb-1 me-3' style="text-align: right;width: 140px" type='text'
                        name='goal_transactions_expenses' value='{{ $goal->goal_transactions_expenses }}'>
                </div>
            </div>
        </div>
    ...
    @section('date_start')
        <div class='circle-date-start'>
            <input type='date' name='date_start' size='20'
                value='{{ date('Y-m-d', strtotime($goal->date_start)) }}'>
    ...
    @section('date_due')
        <div class='circle-date-due'>
            <input type='date' name='date_due' size='20'
                value='{{ date('Y-m-d', strtotime($goal->date_due)) }}'>
    ...
    @section('date_conclusion')
        <div class='circle-date-due'>
            <input type='date' name='date_conclusion' size='20'
                value='{{ date('Y-m-d', strtotime($goal->date_conclusion)) }}'>
