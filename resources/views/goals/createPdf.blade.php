    ...
    <table class="table-list" style="width: 670px">
        ...
        <tr>
            <td class="table-list-header-right"
                style="font-size: 14px;background-color:{{ $data['accountPrincipalColor'] }}" colspan="5">
                TEMPO TOTAL:
            </td>
            <td class="table-list-header-right"
                style="font-size: 14px;padding-right: 5px;background-color:{{ $data['accountPrincipalColor'] }}"
                colspan="1">
