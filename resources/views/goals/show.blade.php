...
@section('buttons')
    <x-buttons.trash :object="$goal" model="goal" />
    <x-buttons.edit model="goal" :object="$goal" />
    <x-buttons.list model='goal' :principalColor=$principalColor ?? null />
@endsection
...
@section('main')
    <div class='row mt-5'>
        ...
        <div class='col-6 pt-4 pb-3 d-flex justify-content-end'
         ...
         border-color: #c28dbf
         '>
            <button id='buttonStageAdd' class='circular-button primary' title='Criar projeto'
                onclick='toogleAddForm("addProject")'>
    ...
    @endif
    <div class='row pt-5 pb-5' id='addProject'
        style='display: none;
     border-left-style: solid;
     border-left-width: 1px;
     border-right-style: solid;
