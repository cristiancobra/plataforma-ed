...
@section('main')
    <div style="padding-left: 6%">
        <form action=" {{ route('competitor.update', ['competitor' => $competitor->id]) }} " method="post"
            ...
            * Se não possui sede e/ou loja física, marque NÃO SE APLICA.
            ...
            <input type="number" step="any" name="google_business_score"
                value="{{ $competitor->google_business_score }}">
            <br>
            <label class="labels" for="">
