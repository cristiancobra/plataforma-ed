...
@section('main')
    ...
    <br>
    <br>
    <label class="labels" for="">Spotfy: </label> <a
        href="{{ $competitor->spotfy }}">{{ $competitor->spotfy }}</a>
    <br>
    <br>
    ...
    <div class="grid-dashboard">
        <div class="facebook">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/facebook.png') }}"
        ...
        <div class="instagram">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/instagram.png') }}"
                    style="width: 100px;height: 100px;text-align: left">
            </div>
            <div style="display: inline-block">
                INSTAGRAM
        ...
        <div class="linkedin">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/linkedin.png') }}"
                    style="width: 100px;height: 100px;text-align: left">
            </div>
            <div style="display: inline-block">
                LINKEDIN
        ...
        <div class="twitter">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/twitter.png') }}"
                    style="width: 100px;height: 100px;text-align: left">
            </div>
            <div style="display: inline-block">
                TWITTER
        ...
        <div class="pinterest">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/pinterest.png') }}"
                    style="width: 100px;height: 100px;text-align: left">
            </div>
            <div style="display: inline-block">
                PINTEREST
        ...
        <div class="spotfy">
            <div style="display: inline-block">
                <img class="grid-image" src="{{ asset('images/spotfy.png') }}"
                    style="width: 100px;height: 100px;text-align: left">
            </div>
            <div style="display: inline-block">
                SPOTFY
    ...
    <div style="text-align:right;padding: 2%">
        <form style="text-decoration: none;display: inline-block"
            action="{{ route('competitor.destroy', ['competitor' => $competitor->id]) }}" method="post">
            @csrf
            @method('delete')
            <input class="btn btn-danger" type="submit" value="APAGAR">
        </form>
        <a class="btn btn-secondary" href=" {{ route('competitor.edit', ['competitor' => $competitor->id]) }} "
