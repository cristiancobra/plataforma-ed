...
<div>
	<form action=" {{route('socialmedia.store')}} " method="post">
		...
		{{editSelect('socialmedia_name', 'fields', returnSocialmediaType(), $socialmedia->socialmedia_name)}}
		<br>
		<label class="labels" for="" >NOME DA PÁGINA: @</label>
		<input type="text" name="name" size="20"value="{{$socialmedia->name}}"><span class="fields"></span>
		<br>
		<label class="labels" for="" >ENDEREÇO DA PÁGINA:</label>
		<input type="text" name="URL_name" size="50"value="{{$socialmedia->URL_name}}"><span class="fields"></span>
		<br>
		<br>
		<label class="labels" for="" >ENDEREÇO DO STUDIO DE CRIAÇÃO:</label>
		<input type="text" name="URL_studio" size="50"value="{{$socialmedia->URL_studio}}"><span class="fields"></span>
		<br>
		<br>
		<label class="labels" for="" >CELULAR DA REDE SOCIAL:</label>
		<input type="text" name="socialmedia_phone" size="50"value="{{$socialmedia->socialmedia_phone}}"><span class="fields"></span>
		<br>
		<br>
		<label class="labels" for="" >EMAIL DA REDE SOCIAL:</label>
		<input type="text" name="socialmedia_email" size="50" value="{{$socialmedia->socialmedia_email}}"><span class="fields"></span>
		<br>
		<br>
		...
		{{createSelect('type', 'fields', $types)}}
		<br>
		<br>
