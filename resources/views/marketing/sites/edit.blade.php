...
@section('main')
    <div>
        <form action=" {{ route('site.update', ['site' => $site->id]) }} " method="post">
            ...
            <input type="text" name="link_edit" size="60" value="{{ $site->link_edit }}"><span
                class="fields"></span>
            <br>
            <label class="labels" for="">LOGIN DO SITE:</label>
            <input type="text" name="site_login" size="60" value="{{ $site->site_login }}"><span
                class="fields"></span>
            <br>
            <label class="labels" for="">SENHA DO SITE:</label>
            <input type="text" name="site_password" size="60" value="{{ $site->site_password }}"><span
                class="fields"></span>
            <br>
            <br>
            ...
            <input type="text" name="link_hosting" size="60" value="{{ $site->link_hosting }}"><span
                class="fields"></span>
            <br>
            <label class="labels" for="">LOGIN DA HOSPEDAGEM:</label>
            <input type="text" name="hosting_login" size="60" value="{{ $site->hosting_login }}"><span
                class="fields"></span>
            <br>
            <label class="labels" for="">SENHA DA HOSPEDAGEM:</label>
            <input type="text" name="hosting_password" size="60" value="{{ $site->hosting_password }}"><span
                class="fields"></span>
            <br>
            <br>
            <label class="labels" for="">DATA DE CRIAÇÃO:</label>
            <input type="date" name="creation_date" size="20" value="{{ $site->creation_date }}"><span
                class="fields"></span>
            <br>
