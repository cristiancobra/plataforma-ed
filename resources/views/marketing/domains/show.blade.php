...
<div style="text-align:right;padding: 2%">
	...
	<a class="button-secondary" href=" {{ route('domain.edit', ['domain' => $domain->id]) }} "  style="text-decoration: none;color: white;display: inline-block">
		<i class='fa fa-edit'></i>EDITAR</a>
	<a class="button-secondary" href="{{route('domain.index')}}">VOLTAR</a>
</div>
<br>
