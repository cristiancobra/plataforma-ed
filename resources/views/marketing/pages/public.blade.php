    ...
    @section('form')
        ...
        <div class='row'>
            <div class='offset-4 col-5 pb-5'>
                <br>
                <input type="checkbox" name="authorization_data"> Autorizo o armazenamento dos meus dados. <span
                ...
                @endif
                <br>
                <input type="checkbox" name="authorization_contact"> Permito que a {{ $accountType }} entre em contato
                comigo.
                <br>
                <input type="checkbox" name="authorization_newsletter"> Quero receber notícias sobre a
                {{ $accountType }} e seus produtos/serviços.
                <br>
