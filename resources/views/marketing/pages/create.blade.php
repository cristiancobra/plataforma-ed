    ...
    <div>
        <form action=" {{ route('page.store') }} " method="post" enctype='multipart/form-data'>
            ...
            * SEM espaços e maiúsculas. Aparece na URL da página depois do domínio.
            ...
            <input type='text' name='principal_color' size='10'
                value='{{ old('principal_color', optional(auth()->user()->account)->principal_color) }}'>
            <br>
            <label class='labels' for=''>COR SECUNDÁRIA</label>
            <input type='text' name='complementary_color' size='10'
                value='{{ old('complementary_color', optional(auth()->user()->account)->complementary_color) }}'>
            <br>
            <label class='labels' for=''>COR OPOSTA</label>
            <input type='text' name='opposite_color' size='10'
                value='{{ old('opposite_color', optional(auth()->user()->account)->opposite_color) }}'>
                ...
                <div class='col-8'>
                    <div class='col pb-5 d-flex justify-content-center'>
                        <div class='col pb-5'>
                            ...
                            @endif
                            <br>
                            <input type='checkbox' name='authorization_contact'> Permito que a empresa entre em contato
                            comigo.
                            <br>
                            <input type='checkbox' name='authorization_newsletter'> Quero receber notícias sobre a empresa
