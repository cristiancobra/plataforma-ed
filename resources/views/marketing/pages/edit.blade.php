...
@section('buttons')
    <a class='circular-button primary' title='Visualizar página' href="{{ route('page.public', ['page' => $page]) }}"
        target='_blank'>
            ...
            <div class='row'>
             ...
             '>
                    ...
                    <p class='pt-5 text-center'
                        style='color: {{ $page->opposite_color }};text-shadow: 2px 2px 4px #000000;font-size: 38px'>
            ...
            <div class='row pb-5'>
                <div class='col'>
                    <p class='text-center' style='color: {{ $valueOfferOppositeColor }};font-size: 22px'>
                        @if ($valueOffer == null)
                            <a class='circular-button primary' title='criar uma proposta de valor'
                                href='{{ route('text.create', ['type' => 'proposta de valor']) }}'>
                ...
                <div class='row pb-5 pt-2'>
                    <div class='col d-flex justify-content-center align-items-center'>
                        <p class='text-center' style='color: {{ $page->opposite_color }};font-size: 22px'>
                            <a class='circular-button primary' title='criar um texto de apresentação'
                                href='{{ route('text.create', ['type' => 'apresentação da empresa']) }}'>
                                <i class='fa fa-plus' aria-hidden='true'></i>
                            </a>
                        </p>
                    </div>
                ...
                <div class='row pt-3'>
                    ...
                    <div class='row pb-5 pt-2'>
                        <div class='col-5 d-flex px-5'>
                            <img src='{{ asset('images/banner-example.jpg') }}' width="320px" height="320px"
                        ...
                        <div class='col-7 d-flex justify-content-center align-items-center'>
                            <p class='text-center' style='color: {{ $page->principal_color }};font-size: 22px'>
                                ...
                                <br>
                                <br>
                                <a class='circular-button primary' title='editar o texto'
                                    href='{{ route('text.edit', ['text' => $about->id]) }}'>
            ...
            <div class='row'>
                <div class='row pt-3'>
                    ...
                    <div class='row pb-5 pt-2'>
                        <div class='col-5 d-flex px-5'>
                            @if ($page->aboutImage)
                                <img src='{{ asset($page->aboutImage->path) }}' width="300px" height="300px"
                                    style="border-radius: 50%">
                            @else
                                <img src='{{ asset('images/banner-example.jpg') }}' width="300px" height="300px"
                                    style="border-radius: 50%">
                            @endif
                        </div>
                        <div class='col-7 d-flex justify-content-center align-items-center'>
        ...
        @else
         ...
         '>
                <div class='row pt-3'>
                    ...
                    <div class='row pb-5 pt-2'>
                        <div class='col-5 d-flex px-5'>
                            <img src='{{ asset('images/banner-example.jpg') }}'
                                style="
                          width:300px;
                          height:300px;
                          border-radius: 50%;
        ...
        @if (!$strengths)
         ...
         '>
                ...
                <div class='row pb-5 pt-2'>
                    <div class='col d-flex justify-content-center align-items-center'>
                        <p class='text-center' style='color: {{ $page->principal_color }};font-size: 22px'>
                            <a class='circular-button primary' title='criar um ponto forte da empresa'
                                href='{{ route('text.create', ['type' => 'força']) }}'>
                                <i class='fa fa-plus' aria-hidden='true'></i>
                            </a>
                        </p>
                    </div>
            ...
            <div class='row pb-5'>
                <div class='col'>
                    <p class='text-center' style='color: {{ $shopOppositeColor }};font-size: 22px'>
                        @if ($products == null)
                            <a class='circular-button primary' title='criar produto'
                                href='{{ route('text.create', ['type' => 'proposta de valor']) }}'>
                                <i class='fa fa-plus' aria-hidden='true'></i>
                            </a>
                        @else
            ...
            <div class='row' style='background-color: {{ $page->opposite_color }}'>
                ...
                <div class='col-4'>
                    @foreach ($formFields as $formField)
                        <div class='row'>
                            <div class='col'>
                                {{ createCheckboxEdit($formField['name'], $formField['value']) }}
                                {{ $formField['label'] }}
                            </div>
                        </div>
                    @endforeach
                        ...
                        @foreach ($formFields as $formField)
                            @if ($formField['name'] == 'contact_state' and $formField['value'] == 1)
                                <div class='row pt-1'>
                                    <div class='col-3 d-flex justify-content-start'>
                                        <label class='labels'
                                            for='contact_state_example'>{{ $formField['label'] }}:</label>
                                    </div>
                                    <div class='col-4 d-flex justify-content-start'>
                                        {{ createDoubleSelect('contact_state_example', 'fields', $states) }}
                                    </div>
                            ...
                            @elseif($formField['value'] == 1)
                                <div class='row pt-1'>
                                    <div class='col-3 d-flex justify-content-start'>
                                        <label class='labels' for=''
                                            style="color: gray">{{ $formField['label'] }}:</label>
                                    </div>
                                    <div class='col-4 d-flex justify-content-start'>
                                        <input type='text' name=''>
                                    </div>
        ...
        @if ($page->form == 1)
         ...
         '>
                <div class='col-4'>
                    ...
                    <br>
                    <span style='font-size: 14px;font-style: italic'>* Obrigatório pela Lei Geral de Proteção de
                        Dados.</span>
                    <br>
                ...
                <div class='col-8'>
                    <div class='col pb-5 d-flex justify-content-center'>
                        <div class='col pb-5'>
                            <br>
                            <input type='checkbox' name='authorization_data_example'> Autorizo o armazenamento dos meus
                            dados.
                            <br>
                            <input type='checkbox' name='authorization_contact_example'> Permito que a empresa entre em
                            contato comigo.
                            <br>
                            <input type='checkbox' name='authorization_newsletter_example'> Quero receber notícias sobre a
