...
<form action=" {{ route('youtube.update', ['youtube' =>$youtube->id]) }} " method="post" style="padding: 40px;color: #874983">
	...
	<div style="padding-left: 6%">
		...
		<input type="radio" name="liked_site" value="yes" checked="checked">
		<span class="fields">Sim</span>
		<br>
		<input type="radio" name="liked_site" value="no">
		<span class="fields">Não</span>
		<br>
		@else
		<input type="radio" name="liked_site" value="yes">
		<span class="fields">Sim</span>
		<br>
		<input type="radio" name="liked_site" value="no" checked="checked">
		<span class="fields">Não</span>
		<br>
		@endif
		<br>
