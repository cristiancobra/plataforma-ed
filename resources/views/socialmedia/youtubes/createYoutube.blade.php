...
@section('main')
    <div>
        <form action=" {{ route('youtube.store') }} " method="post" style="padding: 40px;color: #874983">
            ...
            <br>
            <input type="radio" name="organized_playlists" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
            ...
            <br>
            <input type="radio" name="liked_virtualstore" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
            ...
            <br>
            <input type="radio" name="video_banner" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
            ...
            <br>
            <input type="radio" name="seo_content" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
