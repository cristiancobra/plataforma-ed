...
@section('main')
    <div class="grid-dashboard">
        <div class="facebook">
            <img class="grid-image" src="{{ asset('images/socialmedia/facebook.png') }}"
        ...
        <div class="instagram">
            <img class="grid-image" src="{{ asset('images/socialmedia/instagram.png') }} "
                style="width: 80px;height: 80px;text-align: center">
            <br>
        ...
        <div class="linkedin">
            <img class="grid-image" src="{{ asset('images/socialmedia/linkedin.png') }} "
                style="width: 80px;height: 80px;text-align: center">
            <br>
        ...
        <div class="twitter">
            <img class="grid-image" src="{{ asset('images/socialmedia/twitter.png') }} "
                style="width: 80px;height: 80px;text-align: center">
            <br>
        ...
        <div class="pinterest">
            <img class="grid-image" src="{{ asset('images/socialmedia/pinterest.png') }} "
                style="width: 80px;height: 80px;text-align: center">
            <br>
        ...
        <div class="youtube">
            <img class="grid-image" src="{{ asset('images/socialmedia/youtube.png') }} "
                style="width: 80px;height: 80px;text-align: center">
            <br>
    ...
    <br>
    <div class="spotify">
        <img class="grid-image" src="{{ asset('images/socialmedia/spotify.png') }}"
            style="width: 80px;height: 80px;text-align: center">
        <br>
