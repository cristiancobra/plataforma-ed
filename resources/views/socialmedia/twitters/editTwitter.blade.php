...
@section('main')
    <br>
    <form action=" {{ route('twitter.update', ['twitter' => $twitter->id]) }} " method="post"
        ...
        <div style="padding-left: 6%">
            ...
            <input type="text" name="page_name" size="20" value="{{ $twitter->page_name }}"><span
                class="fields"></span><br>
            <label class="labels" for="">
                ENDEREÇO DA PÁGINA:
            </label>
            <input type="text" name="URL_name" value="{{ $twitter->URL_name }}" size="50"><span
                class="fields"></span><br>
            <label class="labels" for="">
                DONO:
            </label>
