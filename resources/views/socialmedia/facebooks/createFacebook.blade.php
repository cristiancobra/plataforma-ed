...
@section('main')
    <div>
        <form action=" {{ route('facebook.store') }} " method="post" style="padding: 40px;color: #874983">
            ...
            <br>
            <input type="radio" name="linked_instagram" value="yes" checked="checked"><span
            ...
            <br>
            <input type="radio" name="SEO_descriptions" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
            ...
            <br>
            <input type="radio" name="feed_images" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
            ...
            <br>
            <input type="radio" name="interaction" value="yes" checked="checked"><span
                class="fields">Sim</span><br>
