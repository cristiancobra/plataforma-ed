...
@section('main')
    <center>
        ...
        <div style="width: 100%">
            <div class="numbers">
                ...
                <p style="text-align: center; margin: 0px; padding: 0px"><a
                        href="https://vendas.empresadigital.net.br/index.php?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3DTasks%26action%3Dindex%26parentTab%3DAtividades"
                        target="_blank" style="color: yellow">fazer</a></p>
            </div>
            ...
            <div class="numbers">
                ...
                <p style="text-align: center; margin: 0px; padding: 0px"><a
                        href="https://vendas.empresadigital.net.br/?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3DLeads%26action%3Dindex%26parentTab%3DComercial"
                        style="color: yellow">contatar</a></p>
            </div>
            ...
            <div class="numbers">
                ...
                <p style="text-align: center; margin: 0px; padding: 0px"><a
                        href="https://vendas.empresadigital.net.br/?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3DOpportunities%26action%3Dindex%26parentTab%3DComercial"
                        style="color: yellow">vender</a></p>
            </div>
        </div>
    </center>
    ...
    <div style="width:100vw; background-color: white;vertical-align: middle">
        ...
        <div class="admin-blocks">
            ...
            <br>
            <a href="https://nuvem.empresadigital.net.br/index.php/apps/files/?dir=/Empresa%20Digital/operacional/plataforma&fileid=8431"
                target="blank">
