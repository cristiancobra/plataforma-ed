...
@section('main')
    <br>
    <form action=" {{ route('linkedin.update', ['linkedin' => $linkedin->id]) }} " method="post"
        ...
        <div style="padding-left: 6%">
            ...
            <input type="text" name="page_name" size="20" value="{{ $linkedin->page_name }}"><span
                class="fields"></span>
            <label class="labels" for="">
                ENDEREÇO DA PÁGINA:
            </label>
            <input type="text" name="URL_name" value="{{ $linkedin->URL_name }}" size="50"><span
                class="fields"></span>
            <label class="labels" for="">
                DONO:
            </label>
