...
@section('buttons')
    ...
    <x-buttons.list model='user' :principalColor=$principalColor ?? null />
@endsection
...
@section('main')
        ...
        <div class="col-sm-4 col-xs-12 d-inline-block" style="text-align: right">
            <div style='text-align:right;color: #874983; display: inline-block'>
                <form action='{{ route('user.destroy', ['user' => $user->id]) }}' method='post'>
                    @csrf
                    @method('delete')
                    <button id='' class='circular-button delete'
                        style='border:none;padding-left:7px;padding-top: -2px' "type='submit'>
    ...
    <p style='text-align: left;margin-left: 30px;color: white;font-size: 14px'>* se a <b>senha padrão</b> tiver sido
        alterada pelo usuário, atualize a senha novamente com a <b>senha padrão</b>. Peça para o usuário alterar sua senha
        no seu primeiro acesso.</p>
    </div>
