            ...
            <div class='row mt-4'>
                ...
                <div class='description-field'>
                    <p class="labels"">
                        Logomarca:
                        @if ($account->image)
                            <img src="{{ asset($account->image->path) }}" width="180px" height="60px"
                    ...
                    <p class="labels"">
                        Cor principal:
                        <button type="button"
                            style="color:white;background-color:{{ $account->principal_color }};display: inline-block;border-radius:50%">P</button>
                        {{ $account->principal_color }}
                    </p>
                    <p class="labels"">
                        Cor complementar:
                        <button type="button"
                            style="color:white;background-color:{{ $account->complementary_color }};display: inline-block;border-radius:50%">C</button>
                        {{ $account->complementary_color }}
                    </p>
                    <p class="labels"">
                        Cor secundária:
                        <button type="button"
                            style="color:{{ $account->principal_color }};background-color:{{ $account->opposite_color }};display: inline-block;border-radius:50%">O</button>
                        {{ $account->opposite_color }}
                    </p>
                </div>
            </div>
        </div>
