        ...
        <div class='col'>
            ...
            <div class='row'>
                <div class='col d-flex justify-content-center'>
                    <img class='ms-auto me-auto pt-1 pb-2' src='{{ asset('images/cao-astronauta.png') }}' width='160px'
                        height='210px'>
                </div>
            </div>
            <div class='row mt-2'>
                ...
                <div class='row mt-2 mb-5'>
                    <div class='col d-flex justify-content-center'>
                        <a class='text-button primary' target='_blank'
                            href='https://api.whatsapp.com/send?phone=5516981076049&text=Preciso%20de%20ajuda%20com%20a%20minha%20empresa!%20'>WHATSAPP</a>
