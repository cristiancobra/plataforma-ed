...
@section('buttons')
    ...
    <x-buttons.list model='planning' :principalColor=$principalColor ?? null />
@endsection
        ...
        <div class='row'>
            ...
            <div class='tb col-1'>
                @if ($productPlanning->product->image)
                    <image src='{{ asset($productPlanning->product->image->path) }}'
         ...
         '>
            <div class='row mt-0 pt-3 pb-3'>
                <div class="col">
                    ...
                    <p class="fields" for="">
                        Calculamos o valuation (valor de venda) de sua empresa utilizando o método de fluxo de caixa
                        descontado (receitas - despesas - taxa de desconto).
                        A taxa de desconto varia de acordo com o risco do seu negócio, por isso apresentamos 3
                        possibilidades:
                    </p>
                </div>
            </div>
