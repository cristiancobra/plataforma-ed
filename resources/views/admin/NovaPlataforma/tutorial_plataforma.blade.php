...
@section('main')
    <div class="" style="padding: 20px">
        ...
        <li><a href="https://nuvem.empresadigital.net.br/index.php/settings/users" TARGET="_blank">Criar nova conta na
                nuvem</a> seguindo o modelo:
            <br><br>
            ...
            <br>
            <b> Grupos:</b> Escrever <span style="color:red"> {{ $user->name }} </span> <b>apertar o ENTER</b> para criar
            o grupo.
            <br>
        ...
        <br>
        <li>Na lista de usuário, na linha do usuário COBRA na coluna GRUPOS, adicione o grupo do cliente que acabou de ser
            feito. Faça o mesmo com os usuários Evelyn e Nathalia.</li>
        <br>
        <br>
        ...
        <h3>Site novo</h3>
        <li><a href="https://empresadigital.net.br/wp-admin/network/site-new.php" target="_blank">Criar novo site na Rede de
                Sites.</a></li>
        ...
        <li><a href="https://62.171.185.126:8090/websites/empresadigital.net.br" target="_blank">Criar um child domain em
                ADD DOMAINS.</a>
            <br><br>
        ...
        <br><br>
        <li><a href="{{ route('task.create') }} " target="_blank">Criar NOVA TAREFA</a> para Nathalia de acordo com o
            modelo:</li><br>
        ...
        <b> REFERENTE À</b>: Oportunidade (no campo de baixo clicar ne SETA e fazer uma busca por NOME DA CONTA e selecionar
        (clicar no nome da conta).<br>
        <b> NOME DO CONTATO</b>: clicar ne SETA e fazer uma busca por NOME DA CONTA e selecionar (clicar no nome da
        conta).<br>
        <br>
        <b> DESCRIÇÃO</b>:
        <br>
        ...
        <b> Domínio:</b><span style="color:red"> {{ $user->dominio }} </span><br><br>anotar qualquer informação
        adicional.<br>
        <br>
        ...
        <br>
        <li><a href="https://62.171.185.126:8090/websites/empresadigital.net.br" target="_blank">Criar um child domain em
                ADD DOMAINS (dentro do site Empresa Digital).</a>
            <br>
            <br>
            ...
            <br>
            <br>
        <li>Vá em <a href="https://62.171.185.126:8090/websites/listChildDomains"> LISTAR CHILD DOMAINS</a>. Seleciona o
            domínio criado acima e clique em MANAGE > VHOSTS:<br>
            Na primeira linha apagar o nome do domínio, como no modelo abaixo:<br>
            <b>docRoot </b> /home/empresadigital.net.br/public_html/<span style="color:red"> {{ $user->dominio }}
            </span><br><br><br>
            GUARDAR
        </li>
        <br>
        ...
        <li><b>Copiando os arquivos do site NOVO <br></b>
            ...
            Encontre a subpasta com ID do seu site e envie o conteúdo da pasta wp-content/uploads do seu site antigo para:
            <br>
        ...
        <br>
        <br>
        <li> Acessar banco de dados do<b> site antigo</b> pelo PhpMyAdmin. Clique na tab Estrutura. Selecione todas as
            tabelas exceto:
            <br>
            wp_users<br>
            wp_usermeta
        ...
        <br>
        <li>Clique sobre a seleção:na caixa de lista suspensa, selecione Exportar e depois clique em Executar. Isto irá
            baixar o arquivo sql para sua máquina com o conteúdo dessas tabelas.
        </li>
        <br>
        <br>
        ...
        <li>Excluir no banco da rede de sites as tabelas criada automaticamente com<b>wp_id_</b> do site na rede de sites.
        </li>
        ...
        <br>
        De uma olhada em Posts na tela principal e verifique quais autores têm sido atribuídos a eles — há uma boa chance de
        que isso esteja errado. Você pode mudar isso em massa:
        ...
        Verifique se todos os links estão funcionando e se os widgets e plugins estão se comportando como deveriam. Se não,
        você pode voltar no passo anterior do processo, usando seus backups, ou simplesmente configurando os plugins e
        widgets de dentro de seu novo site.
        ...
        <li>Configurar dominio em <a
                href="https://empresadigital.net.br/wp-admin/network/settings.php?page=dm_domains_admin">DOMAIN MAPPING</a>
            com ID e nome do domínio</li>
        <br>
        ...
        <p>
            ...
            8.5. Acessar SQL SERVERS > PHPMYADMIN. Fazer backup do banco de dados XXXXXMOD e exportar/salvar no Nextcloud,
            pasta backups.
            ...
            3.2. Criar usuário com nome do cliente, cota 1G para plataformas livre e 10GB Premium e usar a mesma senha do
            e-mail principal.
