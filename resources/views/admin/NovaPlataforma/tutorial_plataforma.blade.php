...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        @include('MenuLateral/menu-plataforma')
        ...
        <div id="main">
            ...
            <div class="" style="padding: 20px">
                ...
                <ol>
                    ...
                    <li>Deslogue do CRM. Depois <a href="https://vendas.empresadigital.net.br/index.php?module=SecurityGroups&action=EditView&return_module=SecurityGroups&return_action=DetailView" TARGET="_blank"> <b>crie um GRUPO DE SEGURANÇA </a></b> com o nome <b><span style="color:red"> {{ $nome }} </span> </b> e ATRIBUIDO à <b><span style="color:red"> {{ $nome }} </span> </b> . SALVAR
                    </li>
                    <br><br>
					...
					<b>Endereço do site (URL):</b><span style="color:red"> {{ $dominio }} </span><br>
					<b>Título do site:</b><span style="color:red"> {{ $nome }} </span><br>
