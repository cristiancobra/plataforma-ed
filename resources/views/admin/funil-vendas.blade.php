...
<body>
    ...
    <div id="main">
        ...
        <div class="" style="padding: 20px">
            ...
            3.10. Concluir a fase da venda da oportunidade no CRM com PERDEMOS (fim do procedimento) ou GANHAMOS
            (adicione os dados da venda: valor, data de pagamento e produtos vendidos) e seguir para o próximo passo.
            ...
            <ol style="line-height: 2">
                ...
                <li>Concluir a fase da venda da oportunidade no CRM com PERDEMOS (fim do procedimento) ou GANHAMOS
                    (adicione os dados da venda: valor, data de pagamento e produtos vendidos) e seguir para o próximo
                    passo. </li>
                <li>Criar tarefa de contrato no CRM.</li>

                <h2 class="subtitulo-roxo" style="text-align: left">COBRANÇA</h2>
                <li>Criar contrato a partir do CONTRATO MODELO dentro da pasta EMPRESA DIGITAL do CLIENTE e renomear
                    CONTRATO EMPRESA SERVIÇOS ANO.</li>
                ...
                <li>no campo cliente clique na flecha á esquerda e role até o fim e clique em adicionar novo: Adicione
                    as informações: Nome completo, Email pessoal, Moeda real e número de identificação do cliente
                    (colocar CPF e/ CNPJ) e salve. </li>
                <li>Adicionar a data de emissão (dia em que a fatura está sendo criada) e data de vencimento. </li>
                <li>Escolher os produtos e serviços fechados e quantidades. (verificar se o preço do produto fechado é
                    mesmo da tabela)</li>
                <li>Escolher a categoria dos serviços contratados e salvar. </li>
                <li>Marcar fatura como enviada</li>
                <li>Duplicar o total de faturas a serem cobradas (no caso de compras parceladas) e alterar as datas de
                    pagamento.</li>
                ...
                <li>Caso não tenha sido enviado, fazer contato com o cliente salientando que o prazo de 30 dias começa a
                    contar a partir do envio dos materiais.</li>
                <li>Caso o cliente não tenha contratado DIAGNÒSTICO DE MKT DIGITAL deve-se tentar fazer a venda
                    novamente explicando que isso impacta no funil de vendas do site e registrar a venda como
                    OPORTUNIDADE. </li>
