    ...
    <div id="main">
        ...
        <div class="" style="padding: 20px">
            <ol>
                ...
                <li><a href="https://acadia.mxroute.com:2083/cpsess2189633698/frontend/manager/email_accounts/index.html#/create"
                        TARGET="_blank">Criar novo email (usar o login solucoes)</a> seguindo o modelo:
                    <br><br>
                    <b> nome.sobrenome@empresadigital.net.br</b>
                    <br>
                    Colocar <b> 1GB</B>em <b> STORAGE SPACE</b>
                    <br>
                    Clicar em <b> SENHA > GERAR</B>. <a
                        href="https://vendas.empresadigital.net.br/index.php?action=index&module=Contacts&searchFormTab=basic_search&query=true&clear_query=true"
                        TARGET="_blank">Salve esta senha no CRM</a> na DESCRIÇÃO do cliente.


                    <h4>Usuário Empresa</h4>
                <li>Fazer os passo acima mas com <b> 2GB em STORAGE SPACE</b> e <a
                        href="https://acadia.mxroute.com:2083/cpsess2189633698/frontend/manager/mail/addfwd.html"
                        TARGET="_blank"> CRIAR ENCAMINHAMENTO DE EMAIL </a>.
                    <br><br>
                ...
                <li><a href="/logout" target="_blank">Faça logout</a> e cadastre o novo usuário em register seguindo o
                    modelo:</li>
                <br>
                ...
                <br><b>Seu dominio:</b> nomesobrenome.empresadigital.net.br (nome e sobrenome junto, sem ponto e sem
                maiúsculas)
                ...
                <li><a href="https://vendas.empresadigital.net.br/index.php?module=Users&action=EditView&return_module=Users&return_action=DetailView"
                        TARGET="_blank">Criar novo usuário no SuiteCRM</a>
                    <br>Preencher apenas os campos abaixo:
                    <br>Em <b>nome de usuário </b> usar o modelo: <b> nome.sobrenome </b> (tudo minúsculo e junto. Usar
                    dados do próprio CRM)
                    <br>Em <b>EMAIL </b> usar o modelo: <b> nome.sobrenome@empresadigital.net.br</b>
                </li>
                <br><br>
                <li>Clicar no botão <b>CONFIGURAÇÕES </b> no final da página. Na aba CONTAS DE EMAIL clique no botão
                    ADICIONAR. Preencha seguindo o modelo:
                    <br>
                ...
                <li>Na próxima tela em <b>CONTAS DE EMAIL</b>desmarcar o email de Empresa Digital (grupo)
                    <br><br>
                <li><a href="https://vendas.empresadigital.net.br/index.php?module=SecurityGroups&action=EditView&return_module=SecurityGroups&return_action=DetailView"
                        TARGET="_blank">Criar <b>GRUPO DE SEGURANÇA </a></b> com o <b>Nome da Empresa</b> e atribuido ao
                    cliente.
                </li>
                <br><br>
                <li>Na tela seguinte adicionar o cliente como <b>usuário</b> no seu <b>GRUPO DE SEGURANÇA e retirar do
                        grupo EMPRESA DIGITAL</b> no final da página. E <b>adicionar o PERFIL "Administrador da
                        Empresa"</b>
                </li>
                <br><br>
                <li>Acessar o email do cliente e pegar a senha do SuiteCRM. Fazer login como clientee:<br>
                    ...
                    <ul>Na página INICIO do CRM do cliente apagar (clicar no X) os dashlets: Feed, MINHAS CONTAS, MINHAS
                        LIGACOES</ul>
                ...
                <h4>Usuário Grátis</h4>
                <li><a href="https://nuvem.empresadigital.net.br/index.php/settings/users" TARGET="_blank">Criar nova
                        conta na nuvem</a> seguindo o modelo:
                    <br><br>
                ...
                <li>Depois de criado o usuário, na linha do usuário Cobra adicionar nos seus Grupos o grupo do cliente
                    que acabou de ser criado. Fazer o mesmo com a Nathalia, Evelym e Guilherme</li>
                ...
                <li><a href="https://financeiro.empresadigital.net.br/sales/customers/create" TARGET="_blank">Criar
                        conta do cliente</a> seguindo o modelo:
                    <br><br>
                ...
                <h4>Usuário EMPRESA</h4>
                <li><a href="https://financeiro.empresadigital.net.br/auth/users/create" TARGET="_blank">Criar EMPRESA
                        do cliente</a> seguindo o modelo:
                    <br><br>
                ...
                <li><a href="https://financeiro.empresadigital.net.br/auth/users/create" TARGET="_blank">Criar conta do
                        cliente</a> seguindo o modelo:
                    <br><br>
                ...
                <br><br>
                <li><a href="https://empresadigital.net.br/wp-admin/network/site-new.php" target="_blank">Criar NOVA
                        TAREFA</a> para Nathalia de acordo com o modelo:</li><br>
                ...
                <b> REFERENTE À</b>: Oportunidade (no campo de baixo clicar ne SETA e fazer uma busca por NOME DA CONTA
                e selecionar (clicar no nome da conta).<br>
                <b> NOME DO CONTATO</b>: clicar ne SETA e fazer uma busca por NOME DA CONTA e selecionar (clicar no nome
                da conta).<br>
                ...
                <h3>Site novo</h3>
                <li><a href="https://empresadigital.net.br/wp-admin/network/site-new.php" target="_blank">Criar novo
                        site na Rede de Sites.</a></li>
                <li><a href="https://62.171.185.126:8090/websites/empresadigital.net.br" target="_blank">Criar um child
                        domain em ADD DOMAINS (dentro do site Empresa Digital).</a>
                ...
                <li><a href="https://62.171.185.126:8090/websites/empresadigital.net.br" target="_blank">Criar um child
                    ...
                    <br>
                    <br>
                <li>Vá em <a href="https://62.171.185.126:8090/websites/listChildDomains"> LISTAR CHILD DOMAINS</a>.
                    Seleciona o domínio criado acima e clique em MANAGE > VHOSTS:<br>
                ...
                <li><b>Copiando os arquivos do site NOVO <br></b>
                    ...
                    Encontre a subpasta com ID do seu site e envie o conteúdo da pasta wp-content/uploads do seu site
                    antigo para: <br>
                ...
                <br>
                <br>
                <li> Acessar banco de dados do<b> site antigo</b> pelo PhpMyAdmin. Clique na tab Estrutura. Selecione
                ...
                <br>
                <li>Clique sobre a seleção:na caixa de lista suspensa, selecione Exportar e depois clique em Executar.
                    Isto irá baixar o arquivo sql para sua máquina com o conteúdo dessas tabelas.
                </li>
                <br>
                <br>
                ...
                <li>Excluir no banco da rede de sites as tabelas criada automaticamente com<b>wp_id_</b> do site na rede
                    de sites. </li>
                ...
                <br>
                De uma olhada em Posts na tela principal e verifique quais autores têm sido atribuídos a eles — há uma
                boa chance de que isso esteja errado. Você pode mudar isso em massa:
                ...
                Verifique se todos os links estão funcionando e se os widgets e plugins estão se comportando como
                deveriam. Se não, você pode voltar no passo anterior do processo, usando seus backups, ou simplesmente
                configurando os plugins e widgets de dentro de seu novo site.
            ...
            <li> <a href="https://vendas.empresadigital.net.br/index.php?module=Tasks&action=EditView&return_module=Tasks&return_action=DetailView"
                    target="_blank">Criar nova tarefa</a> no modelo:<br>
            ...
            <li>Pegar ID do domínio criado na <a href=https://empresadigital.net.br/wp-admin/network/sites.php">Rede de
                    Sites</a>. Ver o ID no final do link/dominio (passe o mouse em cima, sem clicar).<br></li>
            <li>Configurar dominio em <a
                    href="https://empresadigital.net.br/wp-admin/network/settings.php?page=dm_domains_admin">DOMAIN
                    MAPPING</a> com ID e nome do domínio</li>
            <br>
            ...
            5.5. Acessar SQL SERVERS > PHPMYADMIN. Fazer backup do banco de dados empresad_mautMOD e exportar/salvar no
            Nextcloud, pasta backups.
            5.6. Importar o banco de dados empresad_mautMOD que foi salvo e importar no banco de dados do cliente:
            nome-cliente_mautic
            5.7. Logar via SSH:
            ...
            5.10. Alterar os valores abaixo em amarelo pelo nome do banco de dados e o nome do usuário (que é igual) e a
            senha:
            'db_name' => 'nome-cliente_mautic',
            'db_user' => 'nome-cliente_mautic',
            'db_password' => 'senha-do-banco',
            'site_url' => 'https://dominio-cliente/modelo/mautic',
            'cache_path' => '/home/pasta-cliente/public_html/modelo/mautic/app/cache',         'log_path' =>
            '/home/pasta-cliente/public_html/modelo/mautic/app/logs',
            ...
            5.13. Substituir dados do usuário convidado pelos dados do cliente (usar login e senha padrão do cliente).
            Atribuir a função usuario
            ...
            8.5. Acessar SQL SERVERS > PHPMYADMIN. Fazer backup do banco de dados XXXXXMOD e exportar/salvar no
            Nextcloud, pasta backups.
            8.6. Importar o banco de dados eXXXXXX que foi salvo e importar no banco de dados do cliente:
            nome-cliente_mautic
            8.7. Logar via SSH:
            ssh root@62.171.185.126 -p 2222
            8.8. Executar:
            ...
            8.10. Alterar os valores abaixo em amarelo pelo nome do banco de dados e o nome do usuário (que é igual) e a
            senha:
            'db_name' => 'nome-cliente_mautic',
            'db_user' => 'nome-cliente_mautic',
            'db_password' => 'senha-do-banco',
            ...
            3.2. Criar usuário com nome do cliente, cota 1G para plataformas livre e 10GB Premium e usar a mesma senha
            do e-mail principal.
            ...
            <p>
                ...
                2.3. Voltar e acessar EMAILS > CONTAS DE EMAIL clicar em criar e inserir os e-mails indicados pelo
                cliente.
