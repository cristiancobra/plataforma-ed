    ...
    <body>
        ...
        <div id="main">
            ...
            <div class='secao-iframe'>
                <iframe src='https://crm.empresadigital.net.br/index.php?module=Emails&action=index&parentTab=Colabora%C3%A7%C3%A3o' width='100%' height='100%' border="0px" border="0px"></iframe>
            </div>
        </div>
