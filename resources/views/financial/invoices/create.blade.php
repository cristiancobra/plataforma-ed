...
@section('main')
    ...
    <div>
        <form action=" {{ route('invoice.store') }} " method="post">
            ...
            <input type="date" name="date_creation" size="20" value="{{ old('date_creation') }}"><span
                class="fields"></span>
...
{{ old('description') }}
		...
		{{ old('description') }}
            ...
            <input type="number" name="discount" step='any' style="text-align: right" size='6'
                value="{{ formatCurrency(0) }}"><span class="fields"></span>
            <br>
            <br>
            <label class="labels" for="">NÚMERO DE PARCELAS: </label>
            <input type="number" class="fields" style="text-align: right" name="number_installment_total"
                value="1" max="12">
            <br>
            <br>
