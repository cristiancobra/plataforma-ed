    ...
    <table style="width: 98%;padding-top: 30px;margin-top: -38px">
        <tr>
            <td class="table-list-header center"
                style="width: 8%;background-color:{{ $data['accountComplementaryColor'] }}">
                TIPO
            </td>
            @foreach ($data['months'] as $month)
                <td class="table-list-header center"
                    style="width: 7%;background-color:{{ $data['accountComplementaryColor'] }}">
                    {{ $month }}
                </td>
            @endforeach
            <td class="table-list-header center"
        ...
        @foreach ($data['categories'] as $category)
            <tr>
                ...
                <td class="table-list-header right"
                    style="width: 8%;font-weight: 600;color:black;background-color:lightblue">
    ...
    <table style="width: 98%;padding-top: 30px;margin-top: -38px">
        ...
        @foreach ($data['groups'] as $group)
            <tr>
                ...
                @endforeach
                <td class="table-list-header right"
                    style="width: 8%;font-weight: 600;color:black;background-color:#FDDBDD">
