...
@section('main')
    <div>
        <form action="{{ route('bankAccount.update', ['bankAccount' => $bankAccount]) }}" method="post"
            style="color: #874983">
            @csrf
            @method('put')
            ...
            <input type="decimal" name="opening_balance" size='6'
                value="{{ formatCurrency($bankAccount->opening_balance) }}" style="text-align:right">
            <br>
            <br>
