    ...
    <form id='filter' action='{{ route('transaction.index') }}' method='get'display:none'>
        ...
        <div class="row mt-4">
            <div class="col-2">
                ...
                <br>
                <input type='date' name='date_start' size='20' value='{{ old('date_start') }}'><span
                    class='fields'></span>
            </div>
            <div class="col-2">
                ...
                <br>
                <input type='date' name='date_end' size='20' value='{{ old('date_end') }}'><span
                    class='fields'></span>
            </div>
            <div class="col-2">
     ...
     ">
            ...
            <div class='cel col-2'>
                @if (app('request')->input('contact_id'))
                    <a class='white'
                        href=' {{ route('contact.show', ['contact' => app('request')->input('contact_id')]) }}'>
