...
@section('buttons')
    ...
    <x-buttons.list model='transaction' :principalColor=$principalColor ?? null />
@endsection
...
@section('main')
    ...
    <div>
        <form
            action=" {{ route('transaction.update', [
            ...
            <input type="date" name="pay_day" size="20" value="{{ $transaction->pay_day }}"><span
                class="fields"></span>
            <br>
            ...
            @if ($transaction->value < 0)
                <input type="decimal" name="value" size='12' style="text-align: right" id='value'
                    onkeyup="formatCurrencyReal('value')" value="{{ formatCurrencyReal($transaction->value * -1) }}">
            @else
                <input type="decimal" name="value" size='12' style="text-align: right" id='value'
                    onkeyup="formatCurrencyReal('value')" value="{{ formatCurrencyReal($transaction->value * -1) }}">
            @endif
