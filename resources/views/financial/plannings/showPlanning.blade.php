...
<div style="text-align:right;padding: 2%">
	...
	<a class="button-secondary" href=" {{ route('planning.edit', ['planning' => $planning->id]) }} "  style="text-decoration: none;color: white;display: inline-block">
		<i class='fa fa-edit'></i>EDITAR</a>
	<a class="button-secondary" href="{{route('planning.index')}}">VOLTAR</a>
</div>
<br>
