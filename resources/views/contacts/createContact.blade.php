...
<div>
    <form action="{{route('contact.store')}}" method="post">
        ...
        <label for="">Profissão: </label>
      		 {{createSimpleSelect('profession', 'fields',  $profession) }}
				<br>
        <br>
        ...
        <label for="">Cargo: </label>
   		 {{createSimpleSelect('job_position', 'fields',  $job_position) }}
				<br>
        <br>
        ...
        <p>Utilize esses dados apenas com permissão dos contatos e se você for importante para seu modelo de negócio, obedecendo o previsto na
            ...
            <label for="">Hobbie principal: </label>
				{{createSimpleSelect('hobbie', 'fields',  $hobbie) }}
				<br>
            <label for="">Renda: </label>
            <input type="text" name="income">   
            <br>
            <label for="">Religião: </label>
         {{createSimpleSelect('religion', 'fields',  $religion) }}
				<br>
            <br>
            <label for="">Etinia: </label>
       			 {{createSimpleSelect('etinicity', 'fields',  $etinicity) }}
				<br>
            <br>
