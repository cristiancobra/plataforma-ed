...
@section('main')
    <div class='container mt-5'
     ...
     '>
        <div class='row mt-0'>
            <div class='d-flex col-6 pt-3 pb-3'>
                <div class='d-flex col-6 pt-3 pb-3 align-items-center'>
                ...
                <div class='col-6 pt-4 pb-3 d-flex justify-content-end'>
                    <a id='stageButtonOnOff' class='circular-button primary' title='Criar nova etapa'
                        onclick='toogleAddForm("targetEtapa")'>
                ...
                <form id='addStage' action='{{ route('stage.store') }}' method='post' style='text-align: left'>
                    ...
                    <div class="row">
                        <div class='col' style='text-align:left'>
                            ...
                            <input type='text' name='name' placeholder='nome da ETAPA'
                                style='width:90%;margin-left: 10px' value=''>
                        </div>
                    </div>
                    <div class="row mt-5">
                ...
                <div class="container mt-5"
                    style="
                      border-color: {{ $oppositeColor }};
                       ...
                       padding: 0px;
                ">
                    <div class='row pt-3 pb-2 position-relative'
                        style="margin:auto;background-color: {{ $oppositeColor }}">
                    ...
                    <div class='row pt-0 pb-2 position-relative '
                        style="margin:auto;background-color: {{ $oppositeColor }}">
                        <a class='stretched-link' href='{{ route('stage.edit', ['stage' => $stage->id]) }}'>
                        </a>
                    ...
                    <!--cabeçalho tarefas-->
                    <div class='row table-header mt-2' style="background-color: {{ $principalColor }}; margin: 0;">
                        <div class='col-1'>RESPONSÁVEL</div>
                        <div class='col-1'>INÍCIO</div>
                        <div class='col-7'>TAREFA</div>
                        <div class='col-1'>CONCLUSÃO</div>
                        <div class='col-1'>PRIORIDADE</div>
                        <div class='col-1'>SITUAÇÃO</div>
                    </div>
             ...
             ">
                                ...
                                <div class='cel col-1'>
                                    @if (isset($task->user->image))
                                        <div class='profile-picture-small'>
                                            <a class='white'
                                                href=' {{ route('user.show', ['user' => $task->user->id]) }}'>
                                                <img src='{{ asset($task->user->image->path) }}' width='100%'
                                                    height='100%'>
                                            </a>
                                        </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-1 d-flex justify-content-center pt-2 pb-2'>
                            <a id="taskButtonOnOff_{{ $counter }}" class='circular-button primary'
                                title='Criar nova tarefa' onclick='toogleAddForm("taskRow_{{ $counter }}")'>
                    ...
                    @endif
                    <div class='container pt-5 pb-5' id="taskRow_{{ $counter }}"
                        style='display: none;background-color: #f1f1f1'>
                        <form id='addTask_{{ $counter }}' action='{{ route('task.store') }}' method='post'
                            ...
                            <div class="row mt-5">
                                ...
                                <div class='col-3' style='text-align:left'>
                                    ...
                                    @if (!empty(app('request')->input('date_due')))
                                        <input type="date" name="date_due"
                                            value="{{ app('request')->input('date_due') }}">
                                    @else
                                ...
                                <div class='col-2' style='text-align:left'>
                                    <label class='labels' for='priority'
                                        style='text-align:left;color:{{ $principalColor }}'>
                                        PRIORIDADE
                                    </label>
                                    <br>
     ...
     ">
             ...
             ">
                ...
                <div class='row'>
                    ...
                    <div class='col-1 d-flex justify-content-center pt-2 pb-2'>
                        <a id="taskButtonOnOffExtra" class='circular-button primary' title='Criar nova tarefa'
                            onclick='toogleAddForm("taskRowExtra")'>
                            <i class='fa fa-plus' id='buttonOnOff' aria-hidden='true'></i>
                        </a>
                    </div>
                </div>
                ...
                <div class='container pt-5 pb-5' id="taskRowExtra" style='display: none;background-color: #f1f1f1'>
                    <form id='addTaskExtra' action='{{ route('task.store') }}' method='post'
                        style='text-align: left'>
                        <input type='hidden' name='project_id' value='{{ $project->id }}'>
                        <input type='hidden' name='department' value='{{ $project->department }}'>
                        @csrf
  ...
  {{ old('description') }}
    ...
    @section(' createdAt') <div class='row' style='margin-top: 30px'>
