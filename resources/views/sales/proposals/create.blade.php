...
@section('main')
    ...
    <div class="">
        <form action=' {{ route('proposal.store') }} ' method='post' enctype='multipart/form-data'>
            ...
            <input type='date' name='date_creation' size='20'
                value='{{ old('date_creation') ? old('date_creation') : date('Y-m-d') }}'>
...
{{ old('description') }}
            ...
            @foreach ($products as $product)
                <div class='row'>
                    ...
                    <div class='tb col-1 justify-content-end'
                        ...
                        @else
                            <input type='decimal' name='product_price[]' size='7'
                                value='{{ formatCurrency($product->price * -1) }}' style='text-align: right'>
                        @endif
                    </div>
                </div>
                @php
            ...
            <div class='row mt-5'>
                ...
                <div class='col-2'>
                    <input type='text' name='discount' id='discount' step='any' style='text-align: right'
                        size='6' onkeyup="formatCurrencyReal('discount')">
                </div>
            </div>
