...
@section('attachments')
    @if ($type == 'despesa')
        <x-attachments-section :attachments="$proposal->attachments" modelId="{{ $proposal->id }}" modelIdField="proposal_id"
            :types="['nota_fiscal', 'orcamento_aprovado', 'orcamento_concorrente', 'boleto']" :principalColor="$principalColor" title="DOCUMENTOS FISCAIS" />
    @endif
@endsection
