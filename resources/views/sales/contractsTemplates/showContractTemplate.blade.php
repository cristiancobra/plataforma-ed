...
<div style="text-align:right;padding: 2%">
	...
	<a class="button-secondary" href=" {{ route('contractTemplate.edit', ['contractTemplate' => $contractTemplate->id]) }} "  style="text-decoration: none;color: white;display: inline-block">
		<i class='fa fa-edit'></i>EDITAR</a>
	<a class="button-secondary" href="{{route('contractTemplate.index')}}">VOLTAR</a>
</div>
<br>
<br>
<br>
