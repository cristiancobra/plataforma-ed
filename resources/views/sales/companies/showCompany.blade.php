...
@section('main')
    ...
    <div>
        ...
        <div class="row mt-3 mb-3">
            <div class="col-md-6">
                <label class="labels" for="">Área de atuação 1: </label> {{ $company->field_of_activity_1 }}
                <label class="labels" for="">Área de atuação 2: </label> {{ $company->field_of_activity_2 }}
                <label class="labels" for="">Área de atuação 3: </label> {{ $company->field_of_activity_3 }}
                <label class="labels" for="">Área de atuação 4: </label> {{ $company->field_of_activity_4 }}
                <label class="labels" for="">Área de atuação 5: </label> {{ $company->field_of_activity_5 }}
            </div>
        </div>
        ...
        <div style="text-align:right;padding: 2%">
            ...
            <a class="btn btn-secondary"
                href="{{ route('company.index', ['typeCompanies' => $company->type]) }}">VOLTAR</a>
        </div>
        <br>
    </div>
@endsection
