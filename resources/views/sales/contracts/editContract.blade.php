        ...
        <form action=" {{ route('contract.update', ['contract' => $contract->id]) }} " method="post">
            ...
            <select name="proposal_id">
                <option class="fields" value="{{ $contract->proposal_id }}">
                    {{ $contract->proposal->identifier }} - {{ $contract->company->name }} -
            ...
            <input type="date" name="date_start" size="20" value="{{ $contract->date_start }}"><span
                class="fields"></span>
            <br>
            <label class="labels" for="">DATA DO VENCIMENTO:</label>
            <input type="date" name="date_due" size="20" value="{{ $contract->date_due }}"><span
                class="fields"></span>
            <br>
            <br>
