...
<body>
    ...
    <table style="width: 100%">
        <tr>
            <td class="table-list-header center"
                style="width: 5%;background-color:{{ $data['accountComplementaryColor'] }}">
                QTDE
            </td>
            <td class="table-list-header center"
                style="width: 55%;background-color:{{ $data['accountComplementaryColor'] }}">
                NOME
            </td>
            <td class="table-list-header center"
                style="width: 10%;background-color:{{ $data['accountComplementaryColor'] }}">
                IMPOSTO
            </td>
            <td class="table-list-header center"
                style="width: 15%;background-color:{{ $data['accountComplementaryColor'] }}">
                UNITÁRIO
            </td>
            <td class="table-list-header center"
                style="width: 15%;background-color:{{ $data['accountComplementaryColor'] }}">
        ...
        <tr>
            <td class="table-list-header right"
                style="font-size: 14px;background-color:{{ $data['accountComplementaryColor'] }}" colspan="3">
                desconto:
            </td>
            <td class="table-list-header right"
        ...
        @if ($data['invoiceStatus'] == 'rascunho' or $data['invoiceStatus'] == 'orçamento')
            <tr>
                <td class="table-list-header right" style="background-color:{{ $data['accountComplementaryColor'] }}"
                    colspan="3">
                    PARCELAMENTO:
                </td>
                <td class="table-list-header right" style="background-color:{{ $data['accountComplementaryColor'] }}"
                    ...
                    @if ($data['invoiceNumberInstallmentTotal'] == 1)
                        À vista
                    @else
                        {{ $data['invoiceNumberInstallmentTotal'] }} x
