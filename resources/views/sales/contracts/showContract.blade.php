...
@section('main')
    ...
    <div style="text-align: center;display: inline-block;width: 100%">
        <div>
            <p style="text-align: center;display: inline-block;padding: 5%">
                ...
                <br>
                <span class="labels">{{ $contract->userContact->name }}</span> - <span
                    class="labels">{{ $contract->account->name }}</span>
                <br>
                contratada
                <br>
            </p>
            <p style="text-align: center;display: inline-block;padding: 5%">
                ...
                ________________________________________________
                <br>
                <span class="labels">{{ $contract->contact->name }}</span> - <span
                    class="labels">{{ $contract->company->name }}</span>
                <br>
                contratante
                <br>
            </p>
    ...
    <div style="text-align:right">
        <a class="btn btn-secondary" href=" {{ route('contract.edit', ['contract' => $contract->id]) }} "
