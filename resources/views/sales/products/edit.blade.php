...
@section('form_start')
    ...
    @section('status')
        <input type='decimal' id='price' name='price' onkeyup="formatCurrencyReal('price')"
            style="width:100%;text-align: right" value='{{ formatCurrencyReal($product->price) }}'>
    @endsection
    ...
    @if ($product->category == 'produto físico')
        ...
        @section('content4')
            <input type='number' step="1" min='0' name='initial_stock' style="text-align: right"
