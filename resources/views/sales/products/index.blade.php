...
@section('main')
    <div class="container">
        <div class="row">
            <form id='filter' action='{{ route('product.index', ['variation' => $variation]) }}' method='post'
        ...
        @foreach ($products as $product)
         ...
         ">
                <a
                    class="stretched-link "href="{{ route('product.show', ['product' => $product->id, 'variation' => $variation]) }}">
                </a>
                <div class='cel col-1'>
