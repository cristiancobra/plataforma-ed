...
@section('main')
    ...
    <div class="container m-0 mt-4 mb-5 p-0"
        style='
         border-style: solid;
         border-width: 1px;
         ...
         '>
        <div class="row m-0">
            <div class="cel col m-0 pt-1 pb-1 justify-content-start"
                style='
         ...
         '>
            ...
            <div class="cel col pt-1 pb-1 justify-content-end"
                style='
         background-color: #4863A0;
         color:white;
         font-size: 15px;
