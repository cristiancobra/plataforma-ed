...
@section('main')
    ...
    <div class='tb-row'>
        ...
        <div class='tb-row'>
            <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Proposta de
                valor: </label>
        ...
        <div class='tb-row'>
            <div class='col'>
                <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Diferencial
                    competitivo: </label>
            ...
            <div class='col'>
                <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Modelo de
                    negócio: </label>
        ...
        <div class='tb-row'>
            <div class='col'>
                <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Setor:
                </label>
        ...
        <div class='tb-row'>
            <div class='col'>
                <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Clientes:
                </label>
            ...
            <div class='col'>
                <label class='labels' style='font-size: 13px;padding-top: 5px;margin-right: 3px' for=''>Faturamento:
                </label>
    ...
    <section class='container frame mt-5 p-3' id='invoices' style="border-color:{{ $principalColor }}">
        <div class="row">
            <div class='col-11 pt-4 pb-3'
                style='font-size: 24px;padding-left: 5px;font-weight:600;color:{{ $principalColor }}'>
        ...
        <div class='col-6 pt-4 pb-3'
         ...
         '>
            ...
            <a class='text-button secondary' style='display: inline-block;float: right'
                href='{{ route('opportunity.pdfProduction', ['opportunity' => $opportunity]) }}'>
                RELATÓRIO PDF
            </a>
        </div>
    </div>
    ...
    <div class='row mt-5'>
        ...
        <div class='col-6 pt-4 pb-3'
         ...
         '>
            <a class='circular-button primary' style='display: inline-block;float: right'
                href='{{ route('task.create', ['opportunity' => $opportunity]) }}'>
                <i class='fa fa-plus' aria-hidden='true'></i>
            </a>
        </div>
    </div>
