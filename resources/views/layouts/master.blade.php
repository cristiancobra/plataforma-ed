        ...
        <div class="grid-container">
            <div class="sidebar">
                ...
                <div class="dropdown-container">
                    ...
                    <a class="sidebar-subitem" href="{{route('email.index')}}">
                        <i class="fas fa-envelope" style="margin-right: 8px"></i>EMAILS
                    </a>
                    <a class="sidebar-subitem" href="{{route('campaign.index')}}">
                        <i class="fas fa-envelope" style="margin-right: 8px"></i>CAMPANHAS
                    </a>
