...
class CreateSocialmediasTable extends Migration {
    ...
    public function up() {
        Schema::create('socialmedias', function (Blueprint $table) {
            ...
            $table->string('socialmedia_phone')->nullable();
            $table->string('socialmedia_email')->nullable();
            $table->string('URL_studio')->nullable();
            ...
            $table->integer('female_65')->nullable();
            $table->string('city_followers_1')->nullable();
            $table->integer('number_city_followers_1')->nullable();
            $table->string('city_followers_2')->nullable();
            $table->integer('number_city_followers_2')->nullable();
            $table->string('city_followers_3')->nullable();
            $table->integer('number_city_followers_3')->nullable();
