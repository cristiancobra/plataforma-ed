...
class AddAccountIdColumnInsReportsTable extends Migration {
	...
	public function up() {
		Schema::table('reports', function (Blueprint $table) {
			...
			$table->string('CP1_site_domain_score');
			$table->string('CP1_google_business');
			$table->string('CP1_google_business_score');
			$table->string('CP1_google_business_comments');
			$table->string('CP1_ifood');
			$table->string('CP1_ifood_score');
			$table->string('CP1_ifood_comments');
			$table->string('CP1_spotify');
			$table->string('CP1_city');
			$table->string('CP1_state');
			$table->string('CP1_type');
			$table->string('CP1_facebook_followers');
			$table->string('CP1_instagram_followers');
			$table->string('CP1_linkedin_followers');
			$table->string('CP1_twitter_followers');
			$table->string('CP1_youtube_followers');
			$table->string('CP1_spotfy_followers');
			...
			$table->string('CP2_site_domain_score');
			$table->string('CP2_google_business');
			$table->string('CP2_google_business_score');
			$table->string('CP2_google_business_comments');
			$table->string('CP2_ifood');
			$table->string('CP2_ifood_score');
			$table->string('CP2_ifood_comments');
			$table->string('CP2_spotify');
			$table->string('CP2_city');
			$table->string('CP2_state');
			$table->string('CP2_type');
			$table->string('CP2_facebook_followers');
			$table->string('CP2_instagram_followers');
			$table->string('CP2_linkedin_followers');
			$table->string('CP2_twitter_followers');
			$table->string('CP2_pinterest_followers');
			$table->string('CP2_youtube_followers');
			$table->string('CP2_spotfy_followers');
			...
			$table->string('CP3_google_business_score');
			$table->string('CP3_google_business_comments');
			$table->string('CP3_ifood');
			$table->string('CP3_ifood_score');
			$table->string('CP3_ifood_comments');
			$table->string('CP3_spotify');
			$table->string('CP3_city');
			$table->string('CP3_state');
			$table->string('CP3_type');
			$table->string('CP3_facebook_followers');
			$table->string('CP3_instagram_followers');
			$table->string('CP3_linkedin_followers');
			$table->string('CP3_twitter_followers');
			$table->string('CP3_pinterest_followers');
			$table->string('CP3_youtube_followers');
			$table->string('CP3_spotfy_followers');
		});
	}
